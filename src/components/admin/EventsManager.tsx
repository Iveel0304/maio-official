...
import { Calendar, MapPin, Clock, Users, Plus, Edit, Trash2, Save, X } from 'lucide-react';
...
export default function EventsManager() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (isCreating) {
        response = await eventsApi.createEvent(editingEvent, imageFile || undefined);
      } else {
        response = await eventsApi.updateEvent(editingEvent._id!, editingEvent, imageFile || undefined);
      }
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h2 className="text-2xl font-bold">
            {isCreating 
              ? (language === 'en' ? 'Create New Event' : 'Шинэ арга хэмжээ үүсгэх')
              : (language === 'en' ? 'Edit Event' : 'Арга хэмжээ засах')
            }
          </h2>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <RichTextEditor
                  ...
                  onChange={(content) => setEditingEvent(prev => prev ? {
                    ...prev,
      ...
      <Card>
        <CardContent className="p-4">
          <div className="flex gap-4">
            <Input
              placeholder={language === 'en' ? 'Search events...' : 'Арга хэмжээ хайх...'}
